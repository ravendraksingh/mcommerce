...
import static com.rks.orderservice.constants.ErrorCodeConstants.INTERNAL_SERVER_ERROR_CODE;
...
public class OrderController {
    ...
    public OrderResponse getOrderWithJwt(@PathVariable(value="orderId") Long orderId,
